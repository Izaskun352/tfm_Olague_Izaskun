...
# 4. Ver qué subtipos exactos hay dentro del cerebro y sistema periférico

desglose_nervioso <- metadata %>%
  filter(lineage %in% c("central_nervous_system", "peripheral_nervous_system")) %>%
  count(lineage, lineage_subtype, primary_disease, sort = TRUE)

print(desglose_nervioso)
...
# Análisis por par
carpeta_depmap <- "./Output/Piloto_Microbiota/DepMap_NP_MicroGWAS"
...
matriz_tejidos <- readRDS("./Output/Piloto_Microbiota/DepMap_NP_MicroGWAS/DepMap_Matriz_Tejidos_Maestra.rds")
...
carpeta_crisprbrain <- "./Output/Piloto_Microbiota/CRISPRbrain_Esencialidad_NP_MicroGWAS"
...
tabla_maestra_cb <- readRDS("./Output/Piloto_Microbiota/CRISPRbrain_Esencialidad_NP_MicroGWAS/CRISPRbrain_Esencialidad_Resumen.rds")

carpeta_boxplots_cb <- "./Output/Gráficos/MicroGWAS/Boxplots_Esencialidad_CRISPRbrain_NP_MicroGWAS"
